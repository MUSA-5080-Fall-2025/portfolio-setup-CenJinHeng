...
::: column
![Geographical Distribution of Sale Prices](geo.png){width="100%" align="right"}
:::
:::
...
![Bubble Map of Sale Prices vs. Household Income by Neighborhood](bubble.png){width="100%" align="center"}
...
| Model                                     | CV RMSE  | R²   |
|-------------------------------------------|----------|------|
| Structural Only                           | 139,097  | 0.67  |
| Spatial                                   | 111,374  | 0.79  |
| **Fixed Effects**                         |  95,370  | **0.85** |
| **Hyper-model**                           |  65,382  | **0.93** |
...
**Takeaway:**  
Philadelphia’s housing market is highly localized — accuracy improves most when models reflect neighborhood structure and market context.
The Hyper model which optimized by groups small neighborhoods, is more parsimonious while maintaining high predictive performance.
...
| Model                                      | RMSE (\$) | R² |
|--------------------------------------------|-----------|----|
| Model 3: Fixed Effects  | \$95,370 | 0.85 |
| Model 4: Hyper Model | \$65,382 | 0.93 |
...
![Visualization of Residual by Neighborhood](residuals.png){width="75%" align="center"}
...
- **WIP**
- While our model performs well overall, **further validation** is needed to reduce prediction errors in real-world use.
...
- Data Cleaning: After data cleaning, the dataset was reduced from 24k records to 17k records
- Model Simplicity: Housing prices are influenced by complex and nonlinear factors, while our linear regression framework may not fully capture these patterns.
- Spatial Effects Ignored: Property values are spatially correlated, yet our current model does not explicitly account for geographic dependencies.
